...
_s(Contact, "aXDTq0ugXjmANYdO8zbwH2LWG3A=");
_c = Contact;
var _c;
...
"[project]/src/views/Portfolio.client.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PortfolioClient() {
    ...
    `;
            ...
            function handleScroll() {
                ...
                for (const section of sections.slice().reverse()){
                    ...
                    if (el && window.scrollY >= el.offsetTop - 100) {
                        navButtons.forEach({
                            "PortfolioClient.useEffect.handleScroll": (btn)=>{
                        ...
                        }["PortfolioClient.useEffect.handleScroll"]);
                        break;
                    }
                }
            }
            ...
            navButtons.forEach({
                "PortfolioClient.useEffect": (btn)=>btn.addEventListener('click', handleNavClick)
            }["PortfolioClient.useEffect"]);
            ...
            return ({
                "PortfolioClient.useEffect": ()=>{
                    ...
                    navButtons.forEach({
                        "PortfolioClient.useEffect": (btn)=>btn.removeEventListener('click', handleNavClick)
                    }["PortfolioClient.useEffect"]);
...
_s(PortfolioClient, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = PortfolioClient;
var _c;
...
//# sourceMappingURL=_76e01ed7._.js.map