				...
				<div className="flex flex-col md:flex-row items-center gap-12">
					...
					<div className="w-full md:w-2/3">
						<p className="text-lg leading-relaxed dark:text-slate-300">
							I'm a software developer with a strong foundation in both frontend and backend technologies. I specialize in building full-stack applications using tools like React, Node.js, Express,
							MongoDB, and MySQL.
						</p>
						<p className="text-lg leading-relaxed mt-6 dark:text-slate-300">
							I'm the creator of <span className="font-semibold text-blue-600 dark:text-blue-400">TeyWeb</span>, a platform that empowers businesses to launch customizable e-commerce websites
							instantly. I also co-founded <span className="font-semibold text-blue-600 dark:text-blue-400">Tihaven</span>, a real estate marketplace connecting Nigerians with trusted housing
							opportunities.
						</p>
						<p className="text-lg leading-relaxed mt-6 dark:text-slate-300">
							With over 5 years of experience in software development, I've had the privilege of working with startups and established companies to create meaningful digital experiences that solve
