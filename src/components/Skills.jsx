									...
									<div key={idx} className="relative">
										...
										<div className="h-2 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
											<div
												...
												style={{ width: `${skill.level}%`, transform: 'scaleX(1)' }}></div>
										</div>
									</div>
								))}
							</div>
				...
				<div className="mt-16 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6">
					{['JavaScript', 'React', 'Node.js', 'MongoDB', 'Tailwind', 'Git'].map((tech, idx) => (
						<div
							...
							<div className="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 mb-3">{tech.charAt(0)}</div>
